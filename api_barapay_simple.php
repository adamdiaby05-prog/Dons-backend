<?php
// Endpoint simplifié pour générer un lien de paiement Barapay
...
try {
    ...
    // URL de l'API Barapay (à adapter selon la documentation officielle)
    $barapayApiUrl = 'https://api.barapay.com/v1/payments/create'; // URL d'exemple
    ...
    if ($httpCode === 200) {
        ...
        throw new Exception('Erreur API Barapay: ' . $response);
    }
