<?php
// Endpoint pour générer un lien de paiement Barapay réel
...
try {
    ...
    // URL de l'API Barapay (URL d'exemple - à remplacer par la vraie URL)
    $barapayApiUrl = 'https://api.barapay.com/v1/payments/create';
    ...
    if ($httpCode === 200) {
        ...
        if (isset($result['checkout_url']) || isset($result['payment_url'])) {
