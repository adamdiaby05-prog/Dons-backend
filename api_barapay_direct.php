<?php
// Endpoint utilisant l'API REST Barapay directement avec la bonne URL
...
try {
    ...
    if ($httpCode === 200) {
        ...
        // Si l'API retourne une erreur, on simule une URL de test
        ...
        echo json_encode([
            ...
            'order_no' => $orderNo,
            'message' => 'Lien de paiement généré avec succès',
            'note' => 'URL de test - API Barapay retourne HTTP ' . $httpCode
        ]);
    }
